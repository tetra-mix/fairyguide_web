        ...
        <Container p={{ base: 8, sm: 2 }} id="role">
            ...
            <Center>
                <Flex gap="lg" flexFlow={{base: "row wrap", sm:"column-reverse"}}>
                    <RoleCard name="質問する" description="観光地について質問すると答えてくれます。" image="./slide/IMG_2562.jpeg" />
                    <RoleCard name="案内する" description="特定の場所につくとその場所について案内してくれます。" image="./slide/IMG_2534.jpeg" />
                </Flex>
            </Center>
        </Container>
    );
